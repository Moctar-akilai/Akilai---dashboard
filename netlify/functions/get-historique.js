...
/**
 * GET /Historique — 30 derniers enregistrements, triés par date desc.
 * Champs Airtable : Type (Voix/WhatsApp), Nom, Numero, DateHeure,
 *   Duree, Statut, Resume, Transcription (JSON string), ClientId, NbMessages
 *
  ...
  try {
    ...
    records.forEach((r, i) => {
      ...
      if (type === "voix" || type === "appel") {
        // Parse date + heure from DateHeure (ISO string)
